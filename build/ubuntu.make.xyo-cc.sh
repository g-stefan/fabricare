...
DEF=""
DEF="$DEF -DXYO_PLATFORM_LIBRARY"
DEF="$DEF -DXYO_MANAGEDMEMORY_LIBRARY"
DEF="$DEF -DXYO_DATASTRUCTURES_LIBRARY"
DEF="$DEF -DXYO_MULTITHREADING_LIBRARY"
DEF="$DEF -DXYO_ENCODING_LIBRARY"
DEF="$DEF -DXYO_SYSTEM_LIBRARY"
DEF="$DEF -DXYO_FILEJSON_LIBRARY"
DEF="$DEF -DXYO_CPPCOMPILERCOMMANDDRIVER_LIBRARY"
